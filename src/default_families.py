DEFAULT_FAMILIES = [   {   'groups': [   {   'PriorityAssignees': ['Daniele Donzello', 'Yulia Talybova'],
                      ...
                      {   'PriorityAssignees': ['Martyna Gosz', 'Paweł Woźnicki'],
                          'any-group-count': 0,
                          'exclusive': [   'Third Registrator Wednesday',
    ...
    {   'groups': [   {   'PriorityAssignees': [],
                          'any-group-count': 1,
                          'exclusive': [   'Assisting Beginners Wednesday',
                                           'Photographer Wednesday',
                                           'Teaching Intermediate Bridge Course Wednesday',
                                           'Teaching Intermediate Technique Wednesday',
                                           'Wednesday Milonga Installation',
                      ...
                      {   'PriorityAssignees': [],
                          'any-group-count': 1,
                          'exclusive': [   'Deistalling the Venue + Cleaning - Wednesday',
                                           'Teaching Beginners Wednesday',
                                           'Teaching Intermediate Technique Wednesday',
                                           'Teaching Intermediate Bridge Course Wednesday',
                                           'Photographer Wednesday'],
    ...
    {   'groups': [   {   'PriorityAssignees': [],
                      ...
                      {   'PriorityAssignees': [],
                          'any-group-count': 1,
                          'exclusive': [   'Teaching Intermediate Bridge Course Wednesday',
                                           'Registration Intermediate Bridge Course Wednesday',
                                           'DJ Wednesday',
                                           'Wednesday Milonga Installation'],
                          'follower-group-count': 0,
